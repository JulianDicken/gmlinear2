...
///@arg {r44} M The 4x4 GMLinear matrix to convert.
///@arg {array} <MatOut> (Optional) The output 16-entry matrix to overwrite. If unspecified, return a new 16-entry matrix.
...
///@arg {array} MatIn The 16-entry matrix to convert.
///@arg {r44} <Mout> (Optional) The output 4x4 matrix to overwrite. If unspecified, return a new 4x4 matrix.
