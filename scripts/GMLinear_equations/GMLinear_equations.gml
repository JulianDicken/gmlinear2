...
///@arg {rmn} <Mout> (Optional) The target mxn matrix. If not specified, create a new matrix.
...
///@arg {rmn} M The original mxn matrix.
///@arg {rn} b The reference m-dimensional vector.
///@arg {rn} <vout> (Optional) The target n-dimensional vector to solve to. If not specified, create a new vector.
